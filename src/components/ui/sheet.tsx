...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "display-kicker text-2xl leading-none text-text-primary",
        className
      )}
      {...props}
    />
